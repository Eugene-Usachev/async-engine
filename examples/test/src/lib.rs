...
mod tests {
    ...
    use orengine::test::{run_test_and_block_on_local, run_test_and_block_on_shared, sched_future};
    use std::sync::Arc;
    ...
    fn test_local_without_macro() {
        run_test_and_block_on_local(
            ...
            None,
        ); // Timeouts after 100 ms, not exclusive
    }
    ...
    fn test_test_shared_and_parallel_without_macro() {
        run_test_and_block_on_shared(
            ...
            None,
        ); // Timeouts after 10 s, not exclusive
    }
}

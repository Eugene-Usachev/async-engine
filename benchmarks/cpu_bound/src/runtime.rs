...
pub(crate) struct Results {
    pub create_small_task_and_yield: Option<DurationResult>,
    pub create_large_task_and_yield: Option<DurationResult>,
    pub lock_and_unlock_mutex: Option<DurationResult>,
    pub lock_for_read_and_unlock_rwlock: Option<DurationResult>,
    pub lock_for_write_and_read_and_unlock_rwlock: Option<DurationResult>,
    pub yield_task: Option<DurationResult>,
    pub spawn_many_tasks: Option<SpawnManyTaskResult>,
}
...
pub(crate) trait Runtime: Sized {
    ...
    fn bench_and_print() {
        ...
        print_duration(
            ...
            results.create_small_task_and_yield,
        );
        print_duration(
            "create_large_task_and_yield",
            results.create_large_task_and_yield,
        );
        print_duration("lock_and_unlock_mutex", results.lock_and_unlock_mutex);
        print_duration(
            "lock_for_read_and_unlock_rwlock",
            results.lock_for_read_and_unlock_rwlock,
        );
        print_duration(
            "lock_for_write_and_read_and_unlock_rwlock",
            results.lock_for_write_and_read_and_unlock_rwlock,
        );
        ...
        if let Some(spawn_many_tasks) = results.spawn_many_tasks {
            let (number, dimension) = match spawn_many_tasks.memory_usage_in_bytes {
                ...
                1024..MB => (
                    (spawn_many_tasks.memory_usage_in_bytes as f64) / 1024.0,
                    "KB",
                ),
                MB..GB => (
                    (spawn_many_tasks.memory_usage_in_bytes as f64) / MB as f64,
                    "MB",
                ),
                _ => (
                    (spawn_many_tasks.memory_usage_in_bytes as f64) / GB as f64,
                    "GB",
                ),
            };
            ...
            let tasks_per_gb = spawn_many_tasks.task_count as f64 * GB as f64
                / spawn_many_tasks.memory_usage_in_bytes as f64;
